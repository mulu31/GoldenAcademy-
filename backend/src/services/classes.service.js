...
export const classesService = {
  ...
  update: async (classId, data) => {
    ...
    if (data.homeroom_teacher_id !== undefined) {
      ...
      values.push(data.homeroom_teacher_id ? parseInt(data.homeroom_teacher_id) : null);
    }
  ...
  publishResults: async (classId) => {
    ...
    if (actualMarks < expectedMarks) {
      throw new ApiError(400, 'Cannot publish results: Not all marks have been submitted');
    }
